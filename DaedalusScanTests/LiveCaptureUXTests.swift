...
final class LiveCaptureUXTests: XCTestCase {
    ...
    func testLiveCaptureUtilitiesUseSwipeInSideMenusNotButtonRail() throws {
        ...
        XCTAssertFalse(source.contains("LiveCaptureMenuItem(title: \"Gas\""), "Gas should not be exposed in the live side menu")
        XCTAssertTrue(source.contains("LiveCaptureMenuItem(title: \"Water Pressure Test\""))
        XCTAssertTrue(source.contains("LiveCaptureMenuItem(title: \"Socket & See\""))
        ...
        XCTAssertTrue(source.contains("private struct LiveCaptureRadialDial"), "Capture should expose a radial action dial near the shutter")
        XCTAssertTrue(source.contains("LiveCaptureDialAction(title: \"Finish Room\""))
    }
    ...
    func testLiveCaptureSourceUsesCenterRaycastWithoutMiniTwinPanel() throws {
        ...
        XCTAssertTrue(controlBarSource.contains("LiveCaptureRadialDial"), "Bottom dock may expose survey actions through the radial dial")
    ...
    func testLiveSideControlsUseExistingDomainPaths() throws {
        ...
        XCTAssertTrue(source.contains("SocketSeeTestSheet"), "Electrical side menu should enter Socket & See test results")
        XCTAssertTrue(source.contains("socketRMSVoltage"))
        XCTAssertTrue(source.contains("socketEarthLoopImpedance"))
        XCTAssertTrue(source.contains("socketLoopTestStatus"))
        XCTAssertTrue(source.contains("private func placeGeometryRuler()"))
        XCTAssertTrue(source.contains("private func beginRulerMeasurement()"))
        XCTAssertTrue(source.contains("rulerStartPosition"))
        XCTAssertTrue(source.contains("Ruler start placed"))
        XCTAssertTrue(source.contains("Ruler saved:"))
        XCTAssertTrue(source.contains("isRulerModeActive"))
        XCTAssertTrue(source.contains("rulerReticle(in:"))
        XCTAssertTrue(source.contains("Place ruler point"))
